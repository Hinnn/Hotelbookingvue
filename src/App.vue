    ...
    <b-navbar toggleable="md" variant="dark" type="dark">
      ...
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          ...
          <b-nav-item to="/rooms"><i class="fa fa-money" style="padding: 5px"> Room List</i></b-nav-item>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item to="/customerLogin"><i class="fa fa-info" style="padding: 5px"> Registered customer Login</i></b-nav-item>
          <b-nav-item to="/adminLogin"><i class="fa fa-info" style="padding: 5px"> Admin Login</i></b-nav-item>
          <b-nav-item to="/logout"><i class="fa fa-comment" style="padding: 5px"> Logout</i></b-nav-item>
